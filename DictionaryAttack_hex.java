...
public class DictionaryAttack_hex {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File passwords_file = new File("passwords_hex.txt");
        ...
        while ((line = br.readLine()) != null) {
            ...
            while (salted_passwords_it.hasNext()) {
                ...
                else if (account_password_hash.equals(stringTo_type_salted(account_password_hash_salt,reversed_line,instance_type))) {
                ...
                else if (account_password_hash.equals(stringTo_type_salted(account_password_hash_salt,line_without_vowels,instance_type))){
